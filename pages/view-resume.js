            ...
            <div className="relative max-w-7xl mx-auto ">
                <div className="flex">
                    <a type="button" href="/images/resume/resume.pdf" download="SaranSundar_Resume.pdf"
                            className="mx-auto inline-flex items-center px-6 py-3 mt-10 -mb-5 z-50 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
